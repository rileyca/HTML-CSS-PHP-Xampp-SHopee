 ...
 if($_SESSION['user_id'] == null) {
       ...
       echo 'window.location.href= "../admin/login-admin.php"';
       echo '</script>';
 }
?>  
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/signup-admin.css">
...
<div class="loader"><div></div></div>
        ...
        <li class="header__navbar-item header__navbar-user">
              <!-- <img src="../assets/img/Users/ <?= $_SESSION['Photo'] ?>" alt="error" class="header__navbar-user-img"> -->
               <img src="https://cf.shopee.vn/file/72b7d70d6c27c0144182616780b17845_tn" alt="error" class="header__navbar-user-img">
              ...
              <ul class="header__navbar-user-menu">
                  ...
                  <a href="./logout-admin.php">Log out <i class="ti-shift-right"></i></a>
                  </li> 
              </ul>
      ...
      <?php else: ?>
          ...
          <p><a href="login-admin.php">Log in</a> or <a href="signup-admin.html">sign up</a></p>
