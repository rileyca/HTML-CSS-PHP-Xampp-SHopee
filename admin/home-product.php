...
if($_SESSION['user_id'] ==null){
  ...
  echo  'window.location.href="../login-admin.php"';
  echo '</script>';
}
?>
<?php
    ...
    <div class="snow">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
                 <p><a href="add_product.php" title="Add new product"
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="edit.php?id=<?= $row['productID'] ?>" title="edit"><i class="fa-solid fa-pen"></i></a> &nbsp;
